...
public class CartItemResource {
    ...
    /**
     * {@code GET  /cart-items} : get all the cartItems as a stream.
     * @return the {@link Flux} of cartItems.
     */
    @GetMapping(value = "/cart-items", produces = MediaType.APPLICATION_NDJSON_VALUE)
    public Flux<CartItem> getAllCartItemsAsStream() {
        log.debug("REST request to get all CartItems as a stream");
