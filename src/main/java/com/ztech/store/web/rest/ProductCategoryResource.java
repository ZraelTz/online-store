...
import com.ztech.store.repository.ProductCategoryRepository;
import com.ztech.store.service.ProductCategoryService;
...
/**
 * REST controller for managing {@link com.ztech.store.domain.ProductCategory}.
 */
@RestController
@RequestMapping("/api")
