...
import com.ztech.store.repository.CustomerRepository;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_COUNTRY_STATE = "AAAAAAAAAA";
    private static final String UPDATED_COUNTRY_STATE = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .city(DEFAULT_CITY)
            .countryState(DEFAULT_COUNTRY_STATE);
        // Add required entity
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .city(UPDATED_CITY)
            .countryState(UPDATED_COUNTRY_STATE);
        // Add required entity
        User user = em.insert(UserResourceIT.createEntity(em)).block();
        customer.setUser(user);
        return customer;
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCountryState()).isEqualTo(DEFAULT_COUNTRY_STATE);
    }
    ...
    @Test
    void checkCountryStateIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().collectList().block().size();
        // set the field null
        customer.setCountryState(null);
    ...
    void getAllCustomers() {
        ...
        webTestClient
            ...
            .jsonPath("$.[*].countryState")
            .value(hasItem(DEFAULT_COUNTRY_STATE));
    }
    ...
    void getCustomer() {
        ...
        webTestClient
            ...
            .jsonPath("$.countryState")
            .value(is(DEFAULT_COUNTRY_STATE));
    }
    ...
    void putNewCustomer() throws Exception {
        ...
        assertThat(testCustomer.getCountryState()).isEqualTo(UPDATED_COUNTRY_STATE);
    }
